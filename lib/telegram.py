        ...
        while self.active:
            if self.reconnect:
                ...
                try:
                    ...
                    self.reconnect = True
                    self.send(ADMIN, f"[telegram] Reconnection error: {e}\n\n\n[Bot will reconnect in 2 Min]")
                    await asyncio.sleep(60 * 2)  # Wait before retrying
            ...
            # to do I/O again.
            sleep_time = 0.1 if len(self.outgoing) > 0 else 5.0
